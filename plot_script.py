...
fig, axs = plt.subplots(3,3, figsize=(35, 18))
fig.suptitle('Python Monthly Results', fontsize=30)
x = df.index
...
fig, axs = plt.subplots(3,3, figsize=(35, 18))
fig.suptitle('C++ Monthly Results', fontsize=30)
x = df.index
axs[0][0].plot(x, df['DPM_t_C_ha'], color ="red")
axs[0][0].set_ylabel("t C / ha",fontsize=20)
axs[0][0].set_title("Decomposable Plant Material",fontsize=24)
...
fig, axs = plt.subplots(3,3, figsize=(35, 18))
fig.suptitle('Python Yearly Results', fontsize=30)
x = df.index
axs[0][0].plot(x, df['DPM_t_C_ha'], color ="red")
axs[0][0].set_ylabel("t C / ha",fontsize=20)
axs[0][0].set_title("Decomposable Plant Material",fontsize=24)
...
fig, axs = plt.subplots(3,3, figsize=(35, 18))
fig.suptitle('C++ Yearly Results', fontsize=30)
x = df.index
axs[0][0].plot(x, df['DPM_t_C_ha'], color ="red")
axs[0][0].set_ylabel("t C / ha",fontsize=20)
axs[0][0].set_title("Decomposable Plant Material",fontsize=24)
